...
$sql = "INSERT INTO `borrower`(`name`, `email`, `grantdate`, `duedate`, `amount`, `interest`) VALUES ('$bname','$bemail','$grantdate','$duedate','$amount','$interest')";
...
<form> 
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="formGroupExampleInput2" name="bemail" required>
  </div>
  <div class="form-group">
